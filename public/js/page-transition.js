...
var PageTransitions = function (a) {
    ...
    function b() {
        ...
        var m = location.hash.substr(1), n = a('#page-ajax-loaded'),
    ...
    function e(l) {
        ...
        var u, s = a('.subpages'), t = s.data('current'), v = s.children('section.pt-page'), w = v.length, x = !1,
            y = !1;
    ...
    }[Modernizr.prefixed('animation')], k = Modernizr.cssanimations;
    return {
        init: function (l) {
            a('.pt-page').each(function () {
                ...
                if (location.hash) {
                    ...
                    var r = a(m + ' a[href*="' + location.hash.split('/')[0] + '"]'), s = r[0];
            ...
            if ('' === location.hash) {
                location.hash = n;
                var o = a(m + ' a[href*="' + location.hash.split('/')[0] + '"]'), p = o[0];
                p = a(p.parentNode), p.addClass('active')
            } else {
                var o = a(m + ' a[href*="' + n + '"]'), p = o[0];
